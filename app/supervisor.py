...
headless + 构建期预下载二进制, 冷启动一般 5~20s 内即可就绪。
...
from app.ws_proxy import build_app, env_int
...
async def main() -> None:
    ...
    seed: Optional[str] = os.environ.get("FINGERPRINT_SEED") or None
    ...
    app = build_app(cdp_port=cdp_port)
